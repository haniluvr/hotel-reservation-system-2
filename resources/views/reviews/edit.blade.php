...
@section('title', 'Edit Review - The Belmont Hotel - Discover Your Perfect Getaway. Experience luxury and comfort at Belmont Hotel El Nido, Palawan.')

@section('content')
<div class="min-h-screen bg-black py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto">
        <div class="mb-8">
            <a href="{{ route('bookings.show', $review->reservation_id) }}" class="text-primary-green hover:text-primary-green-hover mb-4 inline-flex items-center">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                </svg>
                Back to Booking
            </a>
            <h1 class="text-3xl md:text-4xl font-bold text-white mb-2">Edit Review</h1>
        </div>
        ...
        <div class="bg-gray-900 rounded-2xl shadow-lg border border-gray-800 p-6">
            <form action="{{ route('reviews.update', $review->id) }}" method="POST" class="space-y-6">
                ...
                <div class="flex gap-4 pt-4">
                    ...
                    <a 
                        href="{{ route('bookings.show', $review->reservation_id) }}" 
